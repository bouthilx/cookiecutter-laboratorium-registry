# -*- coding: utf-8 -*-
#
# laboratorium.registry.{{ cookiecutter.plugin_name }} documentation build configuration file.
#
...
import laboratorium.registry.{{ cookiecutter.plugin_name }} as registry_plugin
...
project = u'laboratorium.registry.{{ cookiecutter.plugin_name }}'
...
latex_documents = [
  (master_doc, 'laboratorium.registry.{{ cookiecutter.plugin_name}}.tex',
   u'Laboratorium registry {{ cookiecutter.plugin_name }} Documentation',
