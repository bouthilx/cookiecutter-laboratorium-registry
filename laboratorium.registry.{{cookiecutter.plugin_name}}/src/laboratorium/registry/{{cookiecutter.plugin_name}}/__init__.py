# -*- coding: utf-8 -*-
"""
:mod:`laboratorium.registry.{{ cookiecutter.plugin_name }} -- {{ cookiecutter.short_description }}
...
__url__ = 'https://github.com/{{ cookiecutter.github_username }}/laboratorium.registry.{{ cookiecutter.plugin_name }}'
